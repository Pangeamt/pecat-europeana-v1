...
const schema = Joi.object({
  ...
  // Second QE score: MTQE combined-score-with-references async endpoint
  // (full URL or its /service/mtqe/v1 base) + its p-api-key. Unset = the
  // pipeline skips the second scoring pass.
